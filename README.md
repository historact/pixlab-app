...
| [`pixlab.env.template`](./Davix-pixlab-app/docs/pixlab.env.template) | Development/staging environment template. |
| [`pixlab.production.env.template`](./Davix-pixlab-app/docs/pixlab.production.env.template) | Production environment template with hardened defaults. |
