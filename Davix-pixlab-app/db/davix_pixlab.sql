...
--
-- Database: `davix_pixlab`
--

-- --------------------------------------------------------

--
-- Table structure for table `admin_login_lockouts`
--

DROP TABLE IF EXISTS `admin_login_lockouts`;
...
--
-- Table structure for table `burst_limits_window`
--

DROP TABLE IF EXISTS `burst_limits_window`;
...
--
-- Table structure for table `internal_rate_limit_windows`
--

DROP TABLE IF EXISTS `internal_rate_limit_windows`;
...
--
-- Table structure for table `lease_locks`
--

DROP TABLE IF EXISTS `lease_locks`;
...
--
-- Table structure for table `quota_ledger`
--
...
--
-- Table structure for table `rate_limits_daily`
--

DROP TABLE IF EXISTS `rate_limits_daily`;
...
--
-- Indexes for table `admin_login_lockouts`
--
...
--
-- Indexes for table `alert_deliveries`
--
...
--
-- Indexes for table `burst_limits_window`
--
...
--
-- Indexes for table `internal_rate_limit_windows`
--
...
--
-- Indexes for table `quota_ledger`
--
...
--
-- Indexes for table `rate_limits_daily`
--
...
ALTER TABLE `schema_migrations`
  ...
  ADD UNIQUE KEY `uq_schema_migrations_name` (`name`);
...
--
-- Indexes for table `usage_monthly`
--
...
--
-- AUTO_INCREMENT for table `alert_deliveries`
--
ALTER TABLE `alert_deliveries`
...
--
-- AUTO_INCREMENT for table `quota_ledger`
--
ALTER TABLE `quota_ledger`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `usage_monthly`
--
ALTER TABLE `usage_monthly`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `alert_state`
--
ALTER TABLE `alert_state`
...
--
-- Constraints for table `usage_monthly`
--
ALTER TABLE `usage_monthly`
