...
function validateEnv() {
  ...
  const intVars = [
    ...
    { name: 'API_KEYS_EXPIRY_WATCHER_INTERVAL_MIN', min: 1 },
    { name: 'API_KEYS_EXPIRY_WATCHER_BATCH_SIZE', min: 1 },
    { name: 'API_KEYS_RETENTION_DAYS', min: 1 },
    { name: 'API_KEYS_RETENTION_CLEANUP_INTERVAL_H', min: 1 },
    { name: 'API_KEYS_RETENTION_CLEANUP_INITIAL_DELAY_S', min: 1 },
    { name: 'API_KEYS_RETENTION_CLEANUP_BATCH_SIZE', min: 1 },
    { name: 'QUOTA_LEDGER_TTL_SECONDS', min: 1 },
    { name: 'QUOTA_LEDGER_RECLAIM_INTERVAL_S', min: 1 },
    ...
    { name: 'ALERT_DELIVERIES_RETENTION_INTERVAL_H', min: 1 },
    { name: 'ALERT_DELIVERIES_RETENTION_INITIAL_DELAY_S', min: 1 },
    { name: 'ALERT_DELIVERIES_RETENTION_BATCH_SIZE', min: 1 },
    { name: 'ALERT_EVENTS_RETENTION_DAYS', min: 1 },
    { name: 'ALERT_EVENTS_RETENTION_INTERVAL_H', min: 1 },
    { name: 'ALERT_EVENTS_RETENTION_INITIAL_DELAY_S', min: 1 },
    { name: 'ALERT_EVENTS_RETENTION_BATCH_SIZE', min: 1 },

    { name: 'H2I_OUTPUT_RETENTION_HOURS', min: 1 },
    { name: 'H2I_OUTPUT_CLEANUP_INTERVAL_H', min: 1 },
    { name: 'IMAGE_OUTPUT_RETENTION_HOURS', min: 1 },
    { name: 'IMAGE_OUTPUT_CLEANUP_INTERVAL_H', min: 1 },
    { name: 'PDF_OUTPUT_RETENTION_HOURS', min: 1 },
    { name: 'PDF_OUTPUT_CLEANUP_INTERVAL_H', min: 1 },
    { name: 'TOOLS_OUTPUT_RETENTION_HOURS', min: 1 },
    { name: 'TOOLS_OUTPUT_CLEANUP_INTERVAL_H', min: 1 },
    { name: 'TEMP_UPLOADS_RETENTION_HOURS', min: 1 },
    { name: 'TEMP_UPLOADS_CLEANUP_INTERVAL_S', min: 1 },
    { name: 'MONITORING_SNAPSHOTS_RETENTION_HOURS', min: 1 },
    { name: 'MONITORING_SNAPSHOTS_CLEANUP_INTERVAL_H', min: 1 },
    ...
    { name: 'H2I_CONCURRENCY_WAIT_S', min: 1 },
    { name: 'IMAGE_CONCURRENCY_WAIT_S', min: 1 },
    { name: 'PDF_CONCURRENCY_WAIT_S', min: 1 },
    { name: 'TOOLS_CONCURRENCY_WAIT_S', min: 1 },
    { name: 'PUBLIC_H2I_TIMEOUT_S', min: 1 },
    { name: 'PUBLIC_IMAGE_TIMEOUT_S', min: 1 },
    { name: 'PUBLIC_PDF_TIMEOUT_S', min: 1 },
    { name: 'PUBLIC_TOOLS_TIMEOUT_S', min: 1 },
    { name: 'OWNER_TIMEOUT_S', min: 1 },
    ...
    { name: 'GLOBAL_MAX_UPLOAD_MB', min: 1 },
    { name: 'GLOBAL_MAX_HTML_CHARS', min: 1 },
    { name: 'GLOBAL_MAX_RENDER_PIXELS', min: 1 },
    { name: 'GLOBAL_MAX_RENDER_WIDTH', min: 1 },
    { name: 'GLOBAL_MAX_RENDER_HEIGHT', min: 1 },
    ...
    { name: 'REQUEST_LOG_CLEANUP_INTERVAL_H', min: 1 },
    { name: 'REQUEST_LOG_CLEANUP_INITIAL_DELAY_S', min: 1 },
    { name: 'REQUEST_LOG_CLEANUP_BATCH_SIZE', min: 1 },
    { name: 'USAGE_MONTHLY_CLEANUP_INTERVAL_H', min: 1 },
    { name: 'USAGE_MONTHLY_CLEANUP_INITIAL_DELAY_S', min: 1 },
    { name: 'USAGE_MONTHLY_CLEANUP_BATCH_SIZE', min: 1 },
    { name: 'RATE_LIMITS_DAILY_CLEANUP_INTERVAL_H', min: 1 },
    { name: 'RATE_LIMITS_DAILY_CLEANUP_INITIAL_DELAY_S', min: 1 },
    { name: 'RATE_LIMITS_DAILY_CLEANUP_BATCH_SIZE', min: 1 },
    { name: 'BURST_LIMITS_WINDOW_CLEANUP_INTERVAL_H', min: 1 },
    { name: 'BURST_LIMITS_WINDOW_CLEANUP_INITIAL_DELAY_S', min: 1 },
    { name: 'BURST_LIMITS_WINDOW_CLEANUP_BATCH_SIZE', min: 1 },
    { name: 'INTERNAL_RATE_LIMIT_WINDOWS_RETENTION_DAYS', min: 1 },
    { name: 'INTERNAL_RATE_LIMIT_WINDOWS_CLEANUP_INTERVAL_MIN', min: 1 },
    { name: 'INTERNAL_RATE_LIMIT_WINDOWS_CLEANUP_INITIAL_DELAY_S', min: 1 },
    { name: 'INTERNAL_RATE_LIMIT_WINDOWS_CLEANUP_BATCH_SIZE', min: 1 },
    { name: 'ADMIN_LOGIN_LOCKOUTS_RETENTION_DAYS', min: 1 },
    { name: 'ADMIN_LOGIN_LOCKOUTS_CLEANUP_INTERVAL_H', min: 1 },
    { name: 'ADMIN_LOGIN_LOCKOUTS_CLEANUP_INITIAL_DELAY_S', min: 1 },
    { name: 'ADMIN_LOGIN_LOCKOUTS_CLEANUP_BATCH_SIZE', min: 1 },
    { name: 'REQUEST_LOG_ORPHAN_CLEANUP_INTERVAL_H', min: 1 },
    { name: 'REQUEST_LOG_ORPHAN_CLEANUP_INITIAL_DELAY_S', min: 1 },
    { name: 'REQUEST_LOG_ORPHAN_CLEANUP_BATCH_SIZE', min: 1 },
    { name: 'USAGE_MONTHLY_ORPHAN_CLEANUP_INTERVAL_H', min: 1 },
    { name: 'USAGE_MONTHLY_ORPHAN_CLEANUP_INITIAL_DELAY_S', min: 1 },
    { name: 'USAGE_MONTHLY_ORPHAN_CLEANUP_BATCH_SIZE', min: 1 },
    { name: 'SUBSCRIPTION_EVENTS_RETENTION_DAYS', min: 1 },
    { name: 'SUBSCRIPTION_EVENTS_CLEANUP_INTERVAL_H', min: 1 },
    { name: 'SUBSCRIPTION_EVENTS_CLEANUP_INITIAL_DELAY_S', min: 1 },
    { name: 'SUBSCRIPTION_EVENTS_CLEANUP_BATCH_SIZE', min: 1 },
    { name: 'ADMIN_SESSIONS_RETENTION_DAYS', min: 1 },
    { name: 'ADMIN_SESSIONS_CLEANUP_INTERVAL_H', min: 1 },
