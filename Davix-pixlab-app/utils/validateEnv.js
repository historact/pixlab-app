...
function validateEnv() {
  ...
  const intVars = [
    ...
    { name: 'EXPIRY_WATCHER_INTERVAL_MS', min: 0 },
    { name: 'EXPIRY_WATCHER_BATCH_SIZE', min: 1 },
    { name: 'ORPHAN_CLEANUP_INTERVAL_MS', min: 0 },
    { name: 'ORPHAN_CLEANUP_INITIAL_DELAY_MS', min: 0 },
    { name: 'ORPHAN_CLEANUP_BATCH', min: 1 },
    { name: 'RETENTION_CLEANUP_INTERVAL_MS', min: 0 },
    { name: 'RETENTION_INITIAL_DELAY_MS', min: 0 },
    { name: 'RETENTION_REQUEST_LOG_DAYS', min: 1 },
    { name: 'RETENTION_USAGE_MONTHLY_MONTHS', min: 1 },
    { name: 'RETENTION_BATCH_REQUEST_LOG', min: 1 },
    { name: 'RETENTION_BATCH_USAGE_MONTHLY', min: 1 },
    ...
    { name: 'RETENTION_RATE_LIMIT_DAYS', min: 1 },
