...
| `ADMIN_LOGIN_LOCKOUTS_CLEANUP_INITIAL_DELAY_S` | ADMIN | int | no | none | utils/retentionCleanup.js:65; utils/validateEnv.js:277 | used |
| `ADMIN_LOGIN_LOCKOUTS_CLEANUP_INTERVAL_H` | ADMIN | int | no | none | utils/retentionCleanup.js:64; utils/validateEnv.js:276 | used |
...
| `ADMIN_SESSIONS_CLEANUP_INTERVAL_H` | ADMIN | int | no | 24 * 60 * 60 * 1000 | server.js:1000; utils/validateEnv.js:290 | used |
...
| `ALERT_DELIVERIES_RETENTION_INITIAL_DELAY_S` | ALERTING | int | no | 60 * 1000 | server.js:102; utils/alertRetentionCleanup.js:12; utils/validateEnv.js:198 | used |
| `ALERT_DELIVERIES_RETENTION_INTERVAL_H` | ALERTING | int | no | 24 * 60 * 60 * 1000 | server.js:100; utils/alertRetentionCleanup.js:10; utils/validateEnv.js:197 | used |
...
| `ALERT_EVENTS_RETENTION_INITIAL_DELAY_S` | ALERTING | int | no | 60 * 1000 | server.js:107; utils/alertRetentionCleanup.js:19; utils/validateEnv.js:202 | used |
| `ALERT_EVENTS_RETENTION_INTERVAL_H` | ALERTING | int | no | 24 * 60 * 60 * 1000 | server.js:106; utils/alertRetentionCleanup.js:17; utils/validateEnv.js:201 | used |
...
| `API_KEYS_EXPIRY_WATCHER_INTERVAL_MIN` | INTERNAL | int | no | 10 * 60 * 1000 | server.js:93; utils/validateEnv.js:186 | used |
...
| `API_KEYS_RETENTION_CLEANUP_INITIAL_DELAY_S` | INTERNAL | int | no | 60 * 1000 | server.js:123; utils/config.js:213; utils/validateEnv.js:192 | used |
| `API_KEYS_RETENTION_CLEANUP_INTERVAL_H` | INTERNAL | int | no | 24 * 60 * 60 * 1000 | server.js:122; utils/config.js:209; utils/validateEnv.js:191 | used |
...
| `BURST_LIMITS_WINDOW_CLEANUP_INITIAL_DELAY_S` | INTERNAL | int | no | none | utils/retentionCleanup.js:51; utils/validateEnv.js:269 | used |
| `BURST_LIMITS_WINDOW_CLEANUP_INTERVAL_H` | INTERNAL | int | no | none | utils/retentionCleanup.js:50; utils/validateEnv.js:268 | used |
...
| `GLOBAL_MAX_UPLOAD_MB` | GLOBAL | string | no | none | utils/limits.js:224; utils/validateEnv.js:241 | used |
...
| `H2I_CONCURRENCY_WAIT_S` | INTERNAL | int | no | none | utils/config.js:110 | used |
| `H2I_DNS_REBINDING_MODE` | INTERNAL | enum | no | '').toString().trim().toLowerCase() | utils/config.js:139; utils/validateEnv.js:325 | used |
| `H2I_OUTPUT_CLEANUP_INTERVAL_H` | INTERNAL | int | no | none | server.js:910; utils/validateEnv.js:206 | used |
...
| `IMAGE_CONCURRENCY_WAIT_S` | INTERNAL | int | no | none | utils/config.js:118 | used |
| `IMAGE_OUTPUT_CLEANUP_INTERVAL_H` | INTERNAL | int | no | none | server.js:911; utils/validateEnv.js:208 | used |
...
| `INTERNAL_RATE_LIMIT_WINDOWS_CLEANUP_INITIAL_DELAY_S` | INTERNAL | int | no | none | utils/retentionCleanup.js:58; utils/validateEnv.js:273 | used |
| `INTERNAL_RATE_LIMIT_WINDOWS_CLEANUP_INTERVAL_MIN` | INTERNAL | int | no | none | utils/retentionCleanup.js:57; utils/validateEnv.js:272 | used |
...
| `MONITORING_SNAPSHOTS_CLEANUP_INTERVAL_H` | DIAGNOSTICS | int | no | (6 * 60 * 60 * 1000)) | utils/monitoringSnapshot.js:14; utils/validateEnv.js:216 | used |
...
| `OWNER_TIMEOUT_S` | OWNER | int | no | none | utils/limits.js:142; utils/validateEnv.js:226 | used |
...
| `PDF_CONCURRENCY_WAIT_S` | INTERNAL | int | no | 15000 | routes/pdf-route.js:62 | used |
| `PDF_OUTPUT_CLEANUP_INTERVAL_H` | INTERNAL | int | no | none | server.js:912; utils/validateEnv.js:210 | used |
...
| `PUBLIC_H2I_TIMEOUT_S` | PUBLIC | int | no | none | utils/validateEnv.js:222 | used |
...
| `PUBLIC_IMAGE_TIMEOUT_S` | PUBLIC | int | no | none | utils/validateEnv.js:223 | used |
...
| `PUBLIC_PDF_TIMEOUT_S` | PUBLIC | int | no | none | utils/validateEnv.js:224 | used |
...
| `PUBLIC_TOOLS_TIMEOUT_S` | PUBLIC | int | no | none | utils/validateEnv.js:225 | used |
...
| `QUOTA_LEDGER_RECLAIM_INTERVAL_S` | INTERNAL | int | no | none | utils/config.js:180; utils/validateEnv.js:189 | used |
...
| `RATE_LIMITS_DAILY_CLEANUP_INITIAL_DELAY_S` | INTERNAL | int | no | none | utils/retentionCleanup.js:43; utils/validateEnv.js:266 | used |
| `RATE_LIMITS_DAILY_CLEANUP_INTERVAL_H` | INTERNAL | int | no | none | utils/retentionCleanup.js:42; utils/validateEnv.js:265 | used |
...
| `REQUEST_LOG_CLEANUP_INITIAL_DELAY_S` | INTERNAL | int | no | none | utils/retentionCleanup.js:27; utils/validateEnv.js:260 | used |
| `REQUEST_LOG_CLEANUP_INTERVAL_H` | INTERNAL | int | no | none | utils/retentionCleanup.js:26; utils/validateEnv.js:259 | used |
| `REQUEST_LOG_ORPHAN_CLEANUP_BATCH_SIZE` | INTERNAL | int | no | none | utils/validateEnv.js:281 | used |
| `REQUEST_LOG_ORPHAN_CLEANUP_INITIAL_DELAY_S` | INTERNAL | int | no | none | utils/validateEnv.js:280 | used |
| `REQUEST_LOG_ORPHAN_CLEANUP_INTERVAL_H` | INTERNAL | int | no | none | utils/validateEnv.js:279 | used |
...
| `SUBSCRIPTION_EVENTS_CLEANUP_INITIAL_DELAY_S` | INTERNAL | int | no | none | utils/validateEnv.js:287 | used |
| `SUBSCRIPTION_EVENTS_CLEANUP_INTERVAL_H` | INTERNAL | int | no | none | utils/validateEnv.js:286 | used |
...
| `TEMP_UPLOADS_CLEANUP_INTERVAL_S` | INTERNAL | int | no | none | server.js:970; utils/validateEnv.js:214 | used |
...
| `TOOLS_CONCURRENCY_WAIT_S` | INTERNAL | int | no | none | utils/config.js:126 | used |
| `TOOLS_OUTPUT_CLEANUP_INTERVAL_H` | INTERNAL | int | no | none | server.js:913; utils/validateEnv.js:212 | used |
...
| `USAGE_MONTHLY_CLEANUP_INITIAL_DELAY_S` | INTERNAL | int | no | none | utils/retentionCleanup.js:35; utils/validateEnv.js:263 | used |
| `USAGE_MONTHLY_CLEANUP_INTERVAL_H` | INTERNAL | int | no | none | utils/retentionCleanup.js:34; utils/validateEnv.js:262 | used |
| `USAGE_MONTHLY_ORPHAN_CLEANUP_BATCH_SIZE` | INTERNAL | int | no | none | utils/validateEnv.js:284 | used |
| `USAGE_MONTHLY_ORPHAN_CLEANUP_INITIAL_DELAY_S` | INTERNAL | int | no | none | utils/validateEnv.js:283 | used |
| `USAGE_MONTHLY_ORPHAN_CLEANUP_INTERVAL_H` | INTERNAL | int | no | none | utils/validateEnv.js:282 | used |
