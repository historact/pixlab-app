...
| `MAX_HTML_CHARS` | utils/limits.js:367 | GLOBAL | used |
| `MAX_RENDER_HEIGHT` | utils/limits.js:369 | GLOBAL | used |
| `MAX_RENDER_PIXELS` | utils/limits.js:370 | GLOBAL | used |
| `MAX_RENDER_WIDTH` | utils/limits.js:368 | GLOBAL | used |
| `MAX_UPLOAD_BYTES` | utils/limits.js:215 | GLOBAL | used |
...
| `OWNER_IMAGE_MAX_DIMENSION_PX` | utils/limits.js:186 | OWNER | used |
| `OWNER_IMAGE_MAX_TOTAL_UPLOAD_MB` | utils/limits.js:185 | OWNER | used |
| `OWNER_MAX_FILES_PER_REQ` | utils/limits.js:200 | OWNER | used |
| `OWNER_PDF_MAX_TOTAL_UPLOAD_MB` | utils/limits.js:189 | OWNER | used |
| `OWNER_TIMEOUT_MS` | utils/limits.js:129 | OWNER | used |
| `OWNER_TOOLS_MAX_DIMENSION_PX` | utils/limits.js:194 | OWNER | used |
| `OWNER_TOOLS_MAX_TOTAL_UPLOAD_MB` | utils/limits.js:193 | OWNER | used |
| `PDF_CONCURRENCY_WAIT_MS` | routes/pdf-route.js:62 | INTERNAL/OTHER | used |
| `PDF_MAX_PAGES_EXTRACT_IMAGES` | utils/limits.js:409 | GLOBAL | used |
| `PDF_MAX_PAGES_SPLIT` | utils/limits.js:410 | GLOBAL | used |
| `PDF_MAX_PAGES_TO_IMAGES` | utils/limits.js:408 | GLOBAL | used |
...
| `PUBLIC_H2I_MAX_HTML_CHARS` | utils/limits.js:375 | PUBLIC | used |
| `PUBLIC_H2I_MAX_RENDER_HEIGHT` | utils/limits.js:377 | PUBLIC | used |
| `PUBLIC_H2I_MAX_RENDER_PIXELS` | utils/limits.js:378 | PUBLIC | used |
| `PUBLIC_H2I_MAX_RENDER_WIDTH` | utils/limits.js:376 | PUBLIC | used |
| `PUBLIC_H2I_TIMEOUT_MS` | utils/limits.js:114 | PUBLIC | used |
| `PUBLIC_IMAGE_DAILY_LIMIT` | routes/image-route.js:54 | PUBLIC | used |
| `PUBLIC_IMAGE_MAX_DIMENSION_PX` | utils/limits.js:166 | PUBLIC | used |
| `PUBLIC_IMAGE_MAX_FILES_PER_REQ` | utils/limits.js:164 | PUBLIC | used |
| `PUBLIC_IMAGE_MAX_TOTAL_UPLOAD_MB` | utils/limits.js:165 | PUBLIC | used |
| `PUBLIC_IMAGE_TIMEOUT_MS` | utils/limits.js:115 | PUBLIC | used |
| `PUBLIC_PDF_DAILY_LIMIT` | routes/pdf-route.js:60 | PUBLIC | used |
| `PUBLIC_PDF_MAX_FILES_PER_REQ` | utils/limits.js:169 | PUBLIC | used |
| `PUBLIC_PDF_MAX_PAGES_EXTRACT_IMAGES` | utils/limits.js:416 | PUBLIC | used |
| `PUBLIC_PDF_MAX_PAGES_SPLIT` | utils/limits.js:417 | PUBLIC | used |
| `PUBLIC_PDF_MAX_PAGES_TO_IMAGES` | utils/limits.js:415 | PUBLIC | used |
| `PUBLIC_PDF_MAX_TOTAL_UPLOAD_MB` | utils/limits.js:170 | PUBLIC | used |
| `PUBLIC_PDF_TIMEOUT_MS` | utils/limits.js:116 | PUBLIC | used |
| `PUBLIC_TOOLS_DAILY_LIMIT` | routes/tools-route.js:70 | PUBLIC | used |
| `PUBLIC_TOOLS_MAX_DIMENSION_PX` | utils/limits.js:176 | PUBLIC | used |
| `PUBLIC_TOOLS_MAX_FILES_PER_REQ` | utils/limits.js:174 | PUBLIC | used |
| `PUBLIC_TOOLS_MAX_TOTAL_UPLOAD_MB` | utils/limits.js:175 | PUBLIC | used |
| `PUBLIC_TOOLS_TIMEOUT_MS` | utils/limits.js:117 | PUBLIC | used |
